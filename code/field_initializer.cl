...
if(value1 == 123 && value2 == 234 && value3 == 345) {
    ...
    Clover.println("value1 -- > " + value1.to_str());
    Clover.println("value2 -- > " + value2.to_str());
    Clover.println("value3 -- > " + value3.to_str());
    System.exit(1);
}
...
if(FieldInitializarTest.array.length() == 3 && FieldInitializarTest.array[0] == "aaa") {
    ...
    "FieldInitializarTest.array.length() --> ".print(); FieldInitializarTest.array.length().to_str().println();
