...
static sNativeMethod gNativeMethods[] = {
    ...
    { "System.realpath(Path)", System_realpath },
    ...
    { "Bytes.append(Bytes)", Bytes_append },
    { "Bytes.cmp(Bytes)", Bytes_cmp },
    { "Bytes.length()", Bytes_length },
    { "Bytes.forward(int)", Bytes_forward },
    { "Bytes.backward(int)", Bytes_backward },
    { "Bytes.getByte()", Bytes_getByte },
    { "Bytes.getShort()", Bytes_getShort },
    { "Bytes.getUInt()", Bytes_getUInt },
    { "Bytes.getLong()", Bytes_getLong },
    { "Bytes.setPoint(long)", Bytes_setPoint },
    { "Bytes.point()", Bytes_point },
    ...
    { "WaitStatus.WIFEXITED()", WaitStatus_WIFEXITED },
    { "WaitStatus.WEXITSTATUS()", WaitStatus_WEXITSTATUS },
    { "WaitStatus.WIFSIGNALED()", WaitStatus_WIFSIGNALED },
    { "WaitStatus.WTERMSIG()", WaitStatus_WTERMSIG },
    { "WaitStatus.WCOREDUMP()", WaitStatus_WCOREDUMP },
    { "WaitStatus.WIFSTOPPED()", WaitStatus_WIFSTOPPED },
    { "WaitStatus.WSTOPSIG()", WaitStatus_WSTOPSIG },
    { "WaitStatus.WIFCONTINUED()", WaitStatus_WIFCONTINUED },
