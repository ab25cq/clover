...
println("1 - 1 -->" + (1 - 1).to_s());
println("4 * 3 -->" + (4 * 3).to_s());
println("6 / 2 -->" + (6 / 2).to_s());
println("6 % 5 -->" + (6 % 5).to_s());
println("1 << 3 -->" + (1 << 3).to_s());
println("8 >> 2 -->" + (8 >> 2).to_s());
println("8 > 2 -->" + (8 > 2).to_s());
println("8 < 2 -->" + (8 < 2).to_s());
...
println("1 >= 2 -->" + (1 >= 2).to_s());
println("3 >= 2 -->" + (3 >= 2).to_s());
println("8 <= 2 -->" + (8 <= 2).to_s());
println("1 <= 2 -->" + (1 <= 2).to_s());
println("2 == 2 -->" + (2 == 2).to_s());
println("2 == 3 -->" + (2 == 3).to_s());
println("2 != 2 -->" + (2 != 2).to_s());
println("2 != 3 -->" + (2 != 3).to_s());
...
println("1 & 1  -->" + (1 & 1).to_s());
println("0 & 1  -->" + (0 & 1).to_s());
println("1|2|4  -->" + (1 | 2 | 4).to_s());
println("1 ^ 1  -->" + (1 ^ 1).to_s());
println("1 ^ 0  -->" + (1 ^ 0).to_s());
println("0x0f   -->" + 0x0f.to_s());
println("017    -->" + 017.to_s());
...
println("false && true -->" + (false && true).to_s());
println("false && false -->" + (false && false).to_s());
println("true || true -->" + (true || true).to_s());
println("false || true -->" + (false || true).to_s());
println("false || false -->" + (false || false).to_s());
println("true || true -->" + (true || true).to_s());
...
println("8.0 < 2.0 -->" + (8.0 < 2.0).to_s());
println("2.1 >= 2.0 -->" + (2.1 >= 2.0).to_s());
println("1.1 >= 2.0 -->" + (1.1 >= 2.0).to_s());
println("3.1 >= 2.0 -->" + (3.1 >= 2.0).to_s());
println("8.1 <= 2.0 -->" + (8.1 <= 2.0).to_s());
println("1.1 <= 2.0 -->" + (1.1 <= 2.0).to_s());
println("2.1 == 2.1 -->" + (2.1 == 2.1).to_s());
println("2.1 == 3.1 -->" + (2.1 == 3.1).to_s());
println("2.1 != 2.1 -->" + (2.1 != 2.1).to_s());
println("2.1 != 3.1 -->" + (2.1 != 3.1).to_s());
...
h.field1 = 123;
println("h.field1               --> " + h.field1.to_s());
...
h.field1 += 123;
println("h.field1+=123          --> " + h.field1.to_s());
...
println("FieldTest.static_field       --> " + FieldTest.static_field.to_s());
...
FieldTest.static_field += 123;
println("FieldTest.static_field+=123  --> " + FieldTest.static_field.to_s());
